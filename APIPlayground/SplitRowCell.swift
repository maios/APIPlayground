...
class SplitRowCell<L: RowType, R: RowType>: Cell<SplitRowValue<L.Cell.Value,R.Cell.Value>>, CellType where L: BaseRow, R: BaseRow {
    ...
    public required init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.addConstraint(NSLayoutConstraint(item: tableViewLeft!,
        ...
        contentView.addConstraint(NSLayoutConstraint(item: tableViewRight!,
    ...
    private func setupConstraints(){
        ...
        if let height = self.height?() {
            self.contentView.addConstraint(NSLayoutConstraint(item: tableViewLeft!,
                                                              attribute: .height,
                                                              ...
                                                              multiplier: 1.0,
                                                              constant: height))
            self.contentView.addConstraint(NSLayoutConstraint(item: tableViewRight!,
                                                              attribute: .height,
                                                              relatedBy: .greaterThanOrEqual,
                                                              toItem: nil,
                                                              attribute: .height,
        ...
        self.contentView.addConstraint(NSLayoutConstraint(item: tableViewLeft!,
                                                          ...
                                                          toItem: contentView,
                                                          attribute: .width,
                                                          multiplier: row.rowLeftPercentage,
                                                          constant: 0.0))
        self.contentView.addConstraint(NSLayoutConstraint(item: tableViewRight!,
                                                          attribute: .width,
                                                          relatedBy: .equal,
                                                          toItem: contentView,
                                                          attribute: .width,
                                                          multiplier: row.rowRightPercentage,
                                                          constant: 0.0))
    }
