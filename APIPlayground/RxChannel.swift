...
func <-><E>(left: ControlProperty<E>, right: ControlProperty<E>) -> Disposable {
...
func <-><E>(left: BehaviorRelay<E>, right: BehaviorRelay<E>) -> Disposable {
...
func <-><E>(left: ControlProperty<E>, right: BehaviorRelay<E>) -> Disposable {
    let leftChannel = RxChannel<E>(withProperty: left)
    let rightChannel = RxChannel<E>.init(withBehaviorRelay: right)
...
class RxChannel<E>: NSObject {
    ...
    override init() {
        ...
        self.leadingTerminal = RxChannelTerminal<E>.init(withValues: AnyObservable<E>(leadingSubject),
                                                         otherTerminal: AnyObserver<E>(followingSubject))
        self.followingTerminal = RxChannelTerminal<E>.init(withValues: AnyObservable<E>(followingSubject),
